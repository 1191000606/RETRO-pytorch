...
# The CPU-only faiss-cpu conda package is currently available on Linux, OSX, and Windows.
# The faiss-gpu, containing both CPU and GPU indices, is available on Linux systems, for various versions of CUDA.
import faiss
